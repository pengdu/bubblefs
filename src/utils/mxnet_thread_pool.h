...
// incubator-mxnet/src/engine/thread_pool.h

#ifndef BUBBLEFS_UTILS_MXNET_THREAD_POOL_H_
#define BUBBLEFS_UTILS_MXNET_THREAD_POOL_H_
...
#endif  // BUBBLEFS_UTILS_MXNET_THREAD_POOL_H_
...
// brpc/src/butil/atomic_sequence_num.h

#ifndef BUBBLEFS_UTILS_BRPC_ATOMIC_SEQUENCE_NUM_H_
#define BUBBLEFS_UTILS_BRPC_ATOMIC_SEQUENCE_NUM_H_
 ...
 public:
  inline int GetNext() {
    return static_cast<int>(
        base::NoBarrier_AtomicIncrement(&seq_, 1) - 1);
  }

...
// parameter_server/src/util/resource_usage.h

#ifndef BUBBLEFS_UTILS_PSLITE_RESOURCE_USAGE_H_
#define BUBBLEFS_UTILS_PSLITE_RESOURCE_USAGE_H_
...
#endif // BUBBLEFS_UTILS_PSLITE_RESOURCE_USAGE_H_
...
// tensorflow/tensorflow/core/lib/histogram/histogram.h

#ifndef BUBBLEFS_UTILS_HISTOGRAM_H_
#define BUBBLEFS_UTILS_HISTOGRAM_H_
...
#endif  // BUBBLEFS_UTILS_HISTOGRAM_H_
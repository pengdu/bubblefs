...
// dmlc-core/include/dmlc/input_split_shuffle.h

#ifndef BUBBLEFS_UTILS_DMLC_INPUT_SPLIT_SHUFFLE_H_
#define BUBBLEFS_UTILS_DMLC_INPUT_SPLIT_SHUFFLE_H_
...
class InputSplitShuffle : public InputSplit {
 public:
  ...
  virtual void ResetPartition(unsigned rank, unsigned nsplit) {
    PANIC_ENFORCE(nsplit == num_parts_, "num_parts is not consistent!");
  ...
  static InputSplit* Create(const char* uri,
                            ...
                            unsigned num_shuffle_parts,
                            int shuffle_seed) {
    PANIC_ENFORCE(num_shuffle_parts > 0, "number of shuffle parts should be greater than zero!");
...
#endif  // BUBBLEFS_UTILS_DMLC_INPUT_SPLIT_SHUFFLE_H_
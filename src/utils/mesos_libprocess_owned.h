...
// mesos/3rdparty/libprocess/include/process/owned.hpp

#ifndef BUBBLEFS_UTILS_MESOS_PROCESS_OWNED_H_
#define BUBBLEFS_UTILS_MESOS_PROCESS_OWNED_H_
...
#endif // BUBBLEFS_UTILS_MESOS_PROCESS_OWNED_H_
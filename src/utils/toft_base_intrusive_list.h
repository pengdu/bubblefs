...
// toft/base/intrusive_list.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_INTRUSIVE_LIST_H_
#define BUBBLEFS_UTILS_TOFT_BASE_INTRUSIVE_LIST_H_
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_INTRUSIVE_LIST_H_
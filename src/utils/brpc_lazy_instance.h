...
#ifndef BUBBLEFS_UTILS_BRPC_LAZY_INSTANCE_H_
#define BUBBLEFS_UTILS_BRPC_LAZY_INSTANCE_H_
...
class LazyInstance {
 public:
  ...
  Type* Pointer() {
    ...
    AtomicWord value = base::Acquire_Load(&private_instance_);
  ...
  bool operator==(Type* p) {
    switch (base::NoBarrier_Load(&private_instance_)) {
      case 0:
        return p == NULL;
 ...
 private:
  Type* instance() {
    return reinterpret_cast<Type*>(base::NoBarrier_Load(&private_instance_));
  }
  ...
  static void OnExit(void* lazy_instance) {
    ...
    base::NoBarrier_Store(&me->private_instance_, 0);
  }
};

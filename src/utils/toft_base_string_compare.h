...
// toft/base/string/compare.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_STRING_COMPARE_H_
#define BUBBLEFS_UTILS_TOFT_BASE_STRING_COMPARE_H_
...
#include <stdint.h>
#include <string>
#include "platform/toft_system_memory_unaligned.h"
...
{
    MYTOFT_STATIC_ASSERT(sizeof(size_t) == 8 || sizeof(size_t) == 4 || sizeof(size_t) == 2);
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_STRING_COMPARE_H_
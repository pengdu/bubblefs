...
// apollo/modules/common/math/aaboxkdtree2d.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_AABOXKDTREE2D_H_
#define BUBBLEFS_UTILS_APOLLO_AABOXKDTREE2D_H_
...
#include "utils/apollo_aabox2d.h"
...
class AABoxKDTree2dNode {
 public:
  ...
  AABoxKDTree2dNode(const std::vector<ObjectPtr> &objects,
      ...
      : depth_(depth) {
    PANIC_ENFORCE(!objects.empty(), "objects is empty");
...
#endif // BUBBLEFS_UTILS_APOLLO_AABOXKDTREE2D_H_ 
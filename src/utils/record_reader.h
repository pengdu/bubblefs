...
// tensorflow/tensorflow/core/lib/io/record_reader.h

#ifndef BUBBLEFS_UTILS_RECORD_READER_H_
#define BUBBLEFS_UTILS_RECORD_READER_H_
...
class RecordReader {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RecordReader);
};
...
#endif  // BUBBLEFS_UTILS_RECORD_READER_H_
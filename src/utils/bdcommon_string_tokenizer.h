...
// apollo/modules/common/util/string_tokenizer.h
...
#ifndef BUBBLEFS_UTILS_BDCOMMON_STRING_TOKENIZER_H_
#define BUBBLEFS_UTILS_BDCOMMON_STRING_TOKENIZER_H_
...
#endif // BUBBLEFS_UTILS_BDCOMMON_STRING_TOKENIZER_H_
...
// tensorflow/tensorflow/core/lib/gtl/edit_distance.h

#ifndef BUBBLEFS_UTILS_EDIT_DISTANCE_H_
#define BUBBLEFS_UTILS_EDIT_DISTANCE_H_
...
#endif  // BUBBLEFS_UTILS_EDIT_DISTANCE_H_
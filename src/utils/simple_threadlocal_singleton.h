...
// thread/mythread/include/mythread/threadlocal_singleton.h

#ifndef BUBBLEFS_UTILS_SIMPLE_THREADLOCAL_SINGLETON_H_
#define BUBBLEFS_UTILS_SIMPLE_THREADLOCAL_SINGLETON_H_

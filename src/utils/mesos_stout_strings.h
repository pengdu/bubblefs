...
// mesos/3rdparty/stout/include/stout/strings.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_STRINGS_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_STRINGS_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_STRINGS_H_
...
// LucenePlusPlus/include/Collection.h

#ifndef BUBBLEFS_UTILS_LUCENE_COLLECTION_H_
#define BUBBLEFS_UTILS_LUCENE_COLLECTION_H_
...
template <class TYPE>
class Collection : public ObjectSync {
public:
...
public:
    static this_type newInstance(int32_t size = 0) {
        this_type instance;
        instance.container = mylucene::newInstance<collection_type>(size);
        return instance;
    }
    ...
    static this_type newInstance(ITER first, ITER last) {
        this_type instance;
        instance.container = mylucene::newInstance<collection_type>(first, last);
        return instance;
    }
...
#endif // BUBBLEFS_UTILS_LUCENE_COLLECTION_H_
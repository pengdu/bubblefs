...
#ifndef BUBBLEFS_UTILS_COCOS2D_MATH_UTIL_H_
#define BUBBLEFS_UTILS_COCOS2D_MATH_UTIL_H_

#include "utils/cocos2d_math_base.h"
...
#endif // BUBBLEFS_UTILS_COCOS2D_MATH_UTIL_H_
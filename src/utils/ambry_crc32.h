...
// ambry/ambry-utils/src/main/java/com.github.ambry.utils/Crc32.java

#ifndef BUBBLEFS_UTILS_AMBRY_CRC32_H_
#define BUBBLEFS_UTILS_AMBRY_CRC32_H_
 ...
 public:
  ...
  void update(char b[], int off, int len) {
    ...
    while (len > 7) {
      ...
      localCrc = (nscrc32::T[T8_7_start + c0] ^ nscrc32::T[T8_6_start + c1]) ^ (nscrc32::T[T8_5_start + c2] ^ nscrc32::T[T8_4_start + c3]);
      ...
      localCrc ^= (nscrc32::T[T8_3_start + c4] ^ nscrc32::T[T8_2_start + c5]) ^ (nscrc32::T[T8_1_start + c6] ^ nscrc32::T[T8_0_start + c7]);
    ...
    switch (len) {
      case 7:
        localCrc = (localCrc >> 8) ^ nscrc32::T[T8_0_start + ((localCrc ^ b[off++]) & 0xff)];
      case 6:
        localCrc = (localCrc >> 8) ^ nscrc32::T[T8_0_start + ((localCrc ^ b[off++]) & 0xff)];
      case 5:
        localCrc = (localCrc >> 8) ^ nscrc32::T[T8_0_start + ((localCrc ^ b[off++]) & 0xff)];
  ...
  //@Override
  void update(int b) {
    crc = (crc >> 8) ^ nscrc32::T[T8_0_start + ((crc ^ b) & 0xff)];
  }
...
#endif // BUBBLEFS_UTILS_AMBRY_CRC32_H_
...
// tensorflow/tensorflow/core/lib/gtl/flatset.h

#ifndef BUBBLEFS_UTILS_FLATSET_H_
#define BUBBLEFS_UTILS_FLATSET_H_
...
#endif  // BUBBLEFS_UTILS_FLATSET_H_
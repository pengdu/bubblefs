...
// LucenePlusPlus/include/UTF8Stream.h

#ifndef BUBBLEFS_UTILS_LUCENE_UTF8_STREAM_H_
#define BUBBLEFS_UTILS_LUCENE_UTF8_STREAM_H_
...
#endif // BUBBLEFS_UTILS_LUCENE_UTF8_STREAM_H_
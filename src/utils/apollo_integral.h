...
// apollo/modules/common/math/integral.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_INTEGRAL_H_
#define BUBBLEFS_UTILS_APOLLO_INTEGRAL_H_
...
#endif  // BUBBLEFS_UTILS_APOLLO_INTEGRAL_H_
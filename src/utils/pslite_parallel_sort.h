...
// ps-lite/include/ps/internal/parallel_sort.h

#ifndef BUBBLEFS_UTILS_PSLITE_PARALLEL_SORT_H_
#define BUBBLEFS_UTILS_PSLITE_PARALLEL_SORT_H_
...
#endif  // BUBBLEFS_UTILS_PSLITE_PARALLEL_SORT_H_
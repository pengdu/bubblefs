...
// bigflow/flume/util/reflection.h
...
#ifndef BUBBLEFS_UTILS_BIGFLOW_FLUME_REFLECTION_H_
#define BUBBLEFS_UTILS_BIGFLOW_FLUME_REFLECTION_H_
...
#ifdef __GNUC__
#define MYBDFLUME_GCC_VERSION (__GNUC__ * 10000 \
    + __GNUC_MINOR__ * 100 \
    + __GNUC_PATCHLEVEL__)
#else
#define MYBDFLUME_GCC_VERSION 0
#endif

#if MYBDFLUME_GCC_VERSION == 30405
#define MYBDFLUME_ANONYMOUT_PREFIX "<unnamed>"
#elif MYBDFLUME_GCC_VERSION >= 40800
#define MYBDFLUME_ANONYMOUT_PREFIX "{anonymous}"
...
#define MYBDFLUME_ANONYMOUT_PREFIX "(anonymous namespace)"
#else
...
const std::string Reflection<BaseType>::UniqueTypeName() {
    ...
    static const char kUnNamed[] = MYBDFLUME_ANONYMOUT_PREFIX;
...
#endif  // BUBBLEFS_UTILS_BIGFLOW_FLUME_REFLECTION_H_
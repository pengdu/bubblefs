...
// toft/container/bitmap.h

#ifndef BUBBLEFS_UTILS_TOFT_CONTAINER_BITMAP_H_
#define BUBBLEFS_UTILS_TOFT_CONTAINER_BITMAP_H_
...
#endif // BUBBLEFS_UTILS_TOFT_CONTAINER_BITMAP_H_
...
// AirSim/AirLib/include/common/common_utils/optional.hpp

# ifndef BUBBLEFS_UTILS_AIRSIM_OPTIONAL_H_
# define BUBBLEFS_UTILS_AIRSIM_OPTIONAL_H_
...
# endif // BUBBLEFS_UTILS_AIRSIM_OPTIONAL_H_
...
// Quake-III-Arena/code/splines/util_str.h

#ifndef BUBBLEFS_UTILS_QUAKE3_UTIL_STR_H_
#define BUBBLEFS_UTILS_QUAKE3_UTIL_STR_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_UTIL_STR_H_
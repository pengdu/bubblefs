...
// AirSim/AirLib/include/common/common_utils/FileSystem.hpp

#ifndef BUBBLEFS_UTILS_AIRSIM_FILE_SYSTEM_H_
#define BUBBLEFS_UTILS_AIRSIM_FILE_SYSTEM_H_
...
#endif // BUBBLEFS_UTILS_AIRSIM_FILE_SYSTEM_H_
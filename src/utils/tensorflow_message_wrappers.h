...
// tensorflow/tensorflow/core/distributed_runtime/message_wrappers.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_MESSAGE_WRAPPERS_H_
#define BUBBLEFS_UTILS_TENSORFLOW_MESSAGE_WRAPPERS_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_MESSAGE_WRAPPERS_H_
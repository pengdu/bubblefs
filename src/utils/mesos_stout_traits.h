...
// mesos/3rdparty/stout/include/stout/traits.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_TRAITS_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_TRAITS_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_TRAITS_H_
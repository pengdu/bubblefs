...
#ifndef BUBBLEFS_UTILS_OPENCC_TEXT_DICT_H_
#define BUBBLEFS_UTILS_OPENCC_TEXT_DICT_H_
...
class TextDict : public Dict, public SerializableDict {
public:
  /**
...
#endif // BUBBLEFS_UTILS_OPENCC_TEXT_DICT_H_
...
// Pebble/src/framework/channel_mgr.h

#ifndef BUBBLEFS_UTILS_PEBBLE_CHANNEL_MGR_H_
#define BUBBLEFS_UTILS_PEBBLE_CHANNEL_MGR_H_
...
typedef std::unordered_map<Subscriber, int64_t> SubscriberList; // 暂使用map做订阅者列表
...
private:
    // 频道本质上是一个名字
    std::unordered_map<std::string, SubscriberList> m_channels; // 频道列表
};

} // namespace mypebble
} // namespace bubblefs

#endif // BUBBLEFS_UTILS_PEBBLE_CHANNEL_MGR_H_
...
#ifndef BUBBLEFS_UTILS_NNVM_TOP_NN_H_
#define BUBBLEFS_UTILS_NNVM_TOP_NN_H_

#include "utils/dmlc_base.h"
#include "utils/dmlc_parameter.h"
#include "utils/nnvm_tuple.h"
...
struct DenseParam : public mydmlc::Parameter<DenseParam> {
  int units;
  bool use_bias;
...
struct DropoutParam : public mydmlc::Parameter<DropoutParam> {
  float rate;
...
struct BatchNormParam : public mydmlc::Parameter<BatchNormParam> {
  int axis;
  double epsilon;
  double momentum;
  bool center;
...
struct SoftmaxParam : public mydmlc::Parameter<SoftmaxParam> {
  int axis;
...
struct LeakyReLUParam : public mydmlc::Parameter<LeakyReLUParam> {
  double alpha;
...
struct Conv2DParam : public mydmlc::Parameter<Conv2DParam> {
  int channels;
  TShape kernel_size;
  TShape strides;
  TShape padding;
...
struct Conv2DTransposeParam : public mydmlc::Parameter<Conv2DTransposeParam> {
  int channels;
  TShape kernel_size;
  TShape strides;
  TShape padding;
...
struct Pool2DParam : public mydmlc::Parameter<Pool2DParam> {
  TShape pool_size;
  TShape strides;
  TShape padding;
  int layout;
...
struct GlobalPool2DParam : public mydmlc::Parameter<GlobalPool2DParam> {
  int layout;
...
#endif  // BUBBLEFS_UTILS_NNVM_TOP_NN_H_
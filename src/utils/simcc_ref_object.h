...
// simcc/simcc/ref_object.h

#ifndef BUBBLEFS_UTILS_SIMCC_REF_OBJECT_H_
#define BUBBLEFS_UTILS_SIMCC_REF_OBJECT_H_
...
class RefObject : public RefCountable {
public:
...
namespace std {
template<class T>
void swap(simcc::RefPtr<T>& l , simcc::RefPtr<T>& r) {
    return l.Swap(r);
}
}

#endif // BUBBLEFS_UTILS_SIMCC_REF_OBJECT_H_
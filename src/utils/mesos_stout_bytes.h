...
// mesos/3rdparty/stout/include/stout/bytes.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_BYTES_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_BYTES_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_BYTES_H_
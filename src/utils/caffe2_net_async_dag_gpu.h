...
// caffe2/caffe2/core/net_async_dag_gpu.h

#ifndef BUBBLEFS_UTILS_CAFFE2_NET_ASYNC_DAG_GPU_H_
#define BUBBLEFS_UTILS_CAFFE2_NET_ASYNC_DAG_GPU_H_

#include "platform/types.h"
#include "utils/caffe2_net_dag.h"
...
class AsyncDAGNet : public DAGNetBase {
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(AsyncDAGNet);
};

} // namespace mycaffe2
} // namespace bubblefs

#endif // BUBBLEFS_UTILS_CAFFE2_NET_ASYNC_DAG_GPU_H_
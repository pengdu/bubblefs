...
// peloton/src/include/index/bloom_filter.h

#ifndef BUBBLEFS_UTILS_PELOTON_BLOOM_FILTER_H_
#define BUBBLEFS_UTILS_PELOTON_BLOOM_FILTER_H_
...
#endif // BUBBLEFS_UTILS_PELOTON_BLOOM_FILTER_H_
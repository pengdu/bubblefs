...
// apollo/modules/planning/math/curve_math.h

/**
 * @file curve_math.h
 **/

#ifndef BUBBLEFS_UTILS_APOLLO_CURVE_MATH_H_
#define BUBBLEFS_UTILS_APOLLO_CURVE_MATH_H_
...
#endif  // BUBBLEFS_UTILS_APOLLO_CURVE_MATH_H_
...
// tensorflow/tensorflow/core/lib/io/inputbuffer.h

#ifndef BUBBLEFS_UTILS_INPUTBUFFER_H_
#define BUBBLEFS_UTILS_INPUTBUFFER_H_
...
#endif  // BUBBLEFS_UTILS_INPUTBUFFER_H_
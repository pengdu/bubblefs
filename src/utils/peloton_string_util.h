...
// peloton/src/include/util/string_util.h

#ifndef BUBBLEFS_UTILS_PELOTON_STRING_UTIL_H_
#define BUBBLEFS_UTILS_PELOTON_STRING_UTIL_H_
...
#endif // BUBBLEFS_UTILS_PELOTON_STRING_UTIL_H_
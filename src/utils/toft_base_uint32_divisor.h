...
// toft/base/uint32_divisor.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_UINT32_DIVISOR_H_
#define BUBBLEFS_UTILS_TOFT_BASE_UINT32_DIVISOR_H_
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_UINT32_DIVISOR_H_
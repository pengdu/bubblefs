...
// incubator-mxnet/src/common/object_pool.h

#ifndef BUBBLEFS_UTILS_MXNET_OBJECT_POOL_H_
#define BUBBLEFS_UTILS_MXNET_OBJECT_POOL_H_
...
void ObjectPool<T>::AllocateChunk() {
  ...
  PANIC_ENFORCE(new_chunk_ptr != NULL, "Allocation failed");
#else
  int ret = posix_memalign(&new_chunk_ptr, kPageSize, kPageSize);
  PANIC_ENFORCE_EQ(ret, 0); // "Allocation failed";
#endif
...
#endif  // BUBBLEFS_UTILS_MXNET_OBJECT_POOL_H_
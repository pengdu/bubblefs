...
// peloton/src/include/parser/abstract_parse.h

#ifndef BUBBLEFS_UTILS_PELOTON_ABSTRACT_PARSE_H_
#define BUBBLEFS_UTILS_PELOTON_ABSTRACT_PARSE_H_
...
#endif // BUBBLEFS_UTILS_PELOTON_ABSTRACT_PARSE_H_
...
// toft/storage/file/file.h

#ifndef BUBBLEFS_UTILS_TOFT_STORAGE_FILE_FILE_H_
#define BUBBLEFS_UTILS_TOFT_STORAGE_FILE_FILE_H_
...
MYTOFT_CLASS_REGISTRY_DEFINE_SINGLETON(file_system, FileSystem);
...
#define MYTOFT_REGISTER_FILE_SYSTEM(prefix, class_name) \
...
#define MYTOFT_GET_FILE_SYSTEM(prefix) \
    MYTOFT_CLASS_REGISTRY_GET_SINGLETON(file_system, prefix)

// Count of registed file systems.
#define MYTOFT_FILE_SYSTEM_COUNT() MYTOFT_CLASS_REGISTRY_CLASS_COUNT(file_system)

// Get file systems name by index
#define MYTOFT_FILE_SYSTEM_NAME(i) MYTOFT_CLASS_REGISTRY_CLASS_NAME(file_system, i)

#endif // BUBBLEFS_UTILS_TOFT_STORAGE_FILE_FILE_H_
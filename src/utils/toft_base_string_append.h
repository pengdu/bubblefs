...
// toft/base/string/append_1.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_STRING_APPEND_H_
#define BUBBLEFS_UTILS_TOFT_BASE_STRING_APPEND_H_
...
#include "utils/toft_base_type_traits.h"
...
void StringAppend(std::string* str, const T& value)
{
    ...
    // disable them
    MYTOFT_STATIC_ASSERT((!std::is_same<T, signed char>::value),
        "signed char is not allowed");
    MYTOFT_STATIC_ASSERT((!std::is_same<T, unsigned char>::value),
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_STRING_APPEND_H_
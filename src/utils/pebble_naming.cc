...
// Pebble/src/framework/naming.cpp

#include <stdio.h>
#include <sstream>
#include "utils/pebble_naming.h"
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
// 避免全局变量构造、析构顺序问题
static std::unordered_map<int32_t, std::shared_ptr<NamingFactory> > * g_naming_factory_map = NULL;
struct NamingFactoryMapHolder {
    ...
    std::unordered_map<int32_t, std::shared_ptr<NamingFactory> > _naming_factory_map;
};

std::shared_ptr<NamingFactory> GetNamingFactory(int32_t type) {
    std::shared_ptr<NamingFactory> null_factory;
    if (!g_naming_factory_map) {
        return null_factory;
    }

    std::unordered_map<int32_t, std::shared_ptr<NamingFactory> >::iterator it =

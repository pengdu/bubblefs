...
// tensorflow/tensorflow/core/framework/function.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_FUNCTION_H_
#define BUBBLEFS_UTILS_TENSORFLOW_FUNCTION_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_FUNCTION_H_
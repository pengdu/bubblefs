...
// mesos/3rdparty/stout/include/stout/linkedhashmap.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_LINKEDHASHMAP_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_LINKEDHASHMAP_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_LINKEDHASHMAP_H_
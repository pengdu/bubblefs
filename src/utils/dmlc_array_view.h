...
// dmlc-core/include/dmlc/array_view.h

#ifndef BUBBLEFS_UTILS_DMLC_ARRAY_VIEW_H_
#define BUBBLEFS_UTILS_DMLC_ARRAY_VIEW_H_
...
#endif  // BUBBLEFS_UTILS_DMLC_ARRAY_VIEW_H_
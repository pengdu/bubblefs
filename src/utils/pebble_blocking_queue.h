...
// Pebble/src/common/blocking_queue.h

#ifndef BUBBLEFS_UTILS_PEBBLE_BLOCKING_QUEUE_H_
#define BUBBLEFS_UTILS_PEBBLE_BLOCKING_QUEUE_H_
...
private:
    ...
    port::Mutex m_mutex;
    port::ConditionVariable m_cond_not_empty;

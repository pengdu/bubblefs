...
// mesos/3rdparty/stout/include/stout/set.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_SET_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_SET_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_SET_H_
...
// Pebble/tools/compiler/pb/src/cpp_generator_helpers.h

#ifndef BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_HELPERS_H_
#define BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_HELPERS_H_
...
#endif  // BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_HELPERS_H_
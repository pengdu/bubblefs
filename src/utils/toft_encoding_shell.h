...
// toft/encoding/shell.h

#ifndef BUBBLEFS_UTILS_TOFT_ENCODING_SHELL_H_
#define BUBBLEFS_UTILS_TOFT_ENCODING_SHELL_H_
...
#endif // BUBBLEFS_UTILS_TOFT_ENCODING_SHELL_H_
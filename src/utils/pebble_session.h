...
// Pebble/src/framework/session.h

#ifndef BUBBLEFS_UTILS_PEBBLE_SESSION_H_
#define BUBBLEFS_UTILS_PEBBLE_SESSION_H_
...
private:
    ...
    std::unordered_map<int64_t, SessionInfo> m_sessions;
...
#endif // BUBBLEFS_UTILS_PEBBLE_SESSION_H_
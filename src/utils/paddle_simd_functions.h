...
// Paddle/paddle/math/SIMDFunctions.h

#ifndef BUBBLEFS_UTILS_PADDLE_SIMD_FUNCTIONS_H_
#define BUBBLEFS_UTILS_PADDLE_SIMD_FUNCTIONS_H_
...
#endif // BUBBLEFS_UTILS_PADDLE_SIMD_FUNCTIONS_H_
...
// bigflow/flume/util/bitset.h

#ifndef BUBBLEFS_UTILS_UTILS_BIGFLOW_BITSET_H_
#define BUBBLEFS_UTILS_UTILS_BIGFLOW_BITSET_H_
...
#endif  // BUBBLEFS_UTILS_UTILS_FLUME_BITSET_H_
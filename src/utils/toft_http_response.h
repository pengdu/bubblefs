...
// toft/net/http/response.h

#ifndef BUBBLEFS_UTILS_TOFT_HTTP_RESPONSE_H_
#define BUBBLEFS_UTILS_TOFT_HTTP_RESPONSE_H_
...
template <>
inline void swap(bubblefs::mytoft::HttpResponse& lhs, bubblefs::mytoft::HttpResponse& rhs) {
    lhs.Swap(&rhs);
}

} // namespace std

#endif // BUBBLEFS_UTILS_TOFT_HTTP_RESPONSE_H_
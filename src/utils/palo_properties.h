...
// palo/be/src/common/configbase.h

#ifndef BUBBLEFS_UTILS_PALO_PROPERTIES_H_
#define BUBBLEFS_UTILS_PALO_PROPERTIES_H_
...
#endif // BUBBLEFS_UTILS_PALO_PROPERTIES_H_
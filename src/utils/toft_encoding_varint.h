...
// toft/encoding/varint.h

#ifndef BUBBLEFS_UTILS_TOFT_ENCODING_VARINT_H_
#define BUBBLEFS_UTILS_TOFT_ENCODING_VARINT_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_ENCODING_VARINT_H_
...
// toft/base/string/number.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_STRING_NUMBER_H_
#define BUBBLEFS_UTILS_TOFT_BASE_STRING_NUMBER_H_
...
{
    MYTOFT_STATIC_ASSERT(std::is_integral<Type>::value, "Type must be integral type");
    char* endptr;
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_STRING_NUMBER_H_
...
// peloton/src/include/common/statement.h

#ifndef BUBBLEFS_UTILS_PELOTON_STATEMENT_H_
#define BUBBLEFS_UTILS_PELOTON_STATEMENT_H_
...
#endif // BUBBLEFS_UTILS_PELOTON_STATEMENT_H_
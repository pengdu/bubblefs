...
// mesos/3rdparty/stout/include/stout/option.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_OPTION_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_OPTION_H_
...
struct hash<Option<T>>
{
  ...
  typedef bubblefs::mymesos::Option<T> argument_type;
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_OPTION_H_
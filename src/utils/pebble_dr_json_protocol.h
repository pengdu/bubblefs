...
#ifndef BUBBLEFS_UTILS_PEBBLE_DR_JSON_PROTOCOL_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_JSON_PROTOCOL_H_
...
#include "utils/pebble_dr_buffer_transport.h"
...
std::string PebbleJSONString(const PebbleStruct& ts) {
    using namespace dr::transport;
    using namespace dr::protocol;
...
}}} // bubblefs::mypebble::dr

#endif // BUBBLEFS_UTILS_PEBBLE_DR_JSON_PROTOCOL_H_
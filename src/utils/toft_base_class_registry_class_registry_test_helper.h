...
// toft/base/class_registry/class_registry_test_helper.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H_
#define BUBBLEFS_UTILS_TOFT_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H_

#include <string>

#include "toft_base_class_registry_class_registry.h"
...
MYTOFT_CLASS_REGISTRY_DEFINE(mapper_registry, Mapper);
...
#define CREATE_MAPPER(mapper_name_as_string) \
    MYTOFT_CLASS_REGISTRY_CREATE_OBJECT(mapper_registry, mapper_name_as_string)

MYTOFT_CLASS_REGISTRY_DEFINE(second_mapper_registry, Mapper);
...
#define CREATE_SECONDARY_MAPPER(mapper_name_as_string) \
    MYTOFT_CLASS_REGISTRY_CREATE_OBJECT(second_mapper_registry, \
...
MYTOFT_CLASS_REGISTRY_DEFINE(reducer_registry, Reducer);
...
#define CREATE_REDUCER(reducer_name_as_string) \
    MYTOFT_CLASS_REGISTRY_CREATE_OBJECT(reducer_registry, reducer_name_as_string)
...
MYTOFT_CLASS_REGISTRY_DEFINE_SINGLETON(file_system_registry, FileSystem);

#define REGISTER_FILE_SYSTEM(path_prefix_as_string, file_impl_name) \
    MYTOFT_CLASS_REGISTRY_REGISTER_CLASS_SINGLETON( \
        file_system_registry, FileSystem, path_prefix_as_string, file_impl_name)

#define GET_FILE_SYSTEM(path_prefix_as_string) \
    MYTOFT_CLASS_REGISTRY_GET_SINGLETON(file_system_registry, path_prefix_as_string)

#define FILE_SYSTEM_COUNT() \
    MYTOFT_CLASS_REGISTRY_CLASS_COUNT(file_system_registry)

#define FILE_SYSTEM_NAME(i) \
    MYTOFT_CLASS_REGISTRY_CLASS_NAME(file_system_registry, i)

} // namespace bubblefs

#endif  // BUBBLEFS_UTILS_TOFT_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H_
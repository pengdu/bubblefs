...
// toft/base/string/byte_set.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_STRING_BYTE_SET_H_
#define BUBBLEFS_UTILS_TOFT_BASE_STRING_BYTE_SET_H_
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_STRING_BYTE_SET_H_
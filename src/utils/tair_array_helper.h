...
// tfs/src/common/array_helper.h

#ifndef BUBBLES_UTILS_TAIR_ARRAY_HELPER_H_
#define BUBBLES_UTILS_TAIR_ARRAY_HELPER_H_
...
#endif BUBBLES_UTILS_TAIR_ARRAY_HELPER_H_
...
// tensorflow/tensorflow/core/distributed_runtime/master_session.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_MASTER_SESSION_H_
#define BUBBLEFS_UTILS_TENSORFLOW_MASTER_SESSION_H_
...
#include "utils/tensorflow_call_options.h"
#include "utils/tensorflow_message_wrappers.h"
#include "utils/tensorflow_worker_cache.h"
...
class MasterSession : public core::RefCounted {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MasterSession);
};

}  // namespace mytensorflow
}  // namespace bubblefs

#endif  // BUBBLEFS_UTILS_TENSORFLOW_MASTER_SESSION_H_
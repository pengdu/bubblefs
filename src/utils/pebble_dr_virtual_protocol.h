...
// Pebble/src/framework/dr/protocol/virtual_protocol.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_PROTOCOL_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_PROTOCOL_H_
...
class TVirtualProtocol : public Super_ {
 public:
  ...
  uint32_t skip(TType type) {
    ...
    return dr::protocol::skip(*prot, type);
  }
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_PROTOCOL_H_
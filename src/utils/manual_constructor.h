...
// tensorflow/tensorflow/core/lib/gtl/manual_constructor_test.h
...
#ifndef BUBBLEFS_UTILS_MANUAL_CONSTRUCTOR_H_
#define BUBBLEFS_UTILS_MANUAL_CONSTRUCTOR_H_
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size)                          \
  typename bubblefs::gtl::internal::AlignType<TF_LIB_GTL_ALIGN_OF(T), \
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size) \
  bubblefs::gtl::internal::AlignType<Size * sizeof(T)>::result
...
#endif  // BUBBLEFS_UTILS_MANUAL_CONSTRUCTOR_H_
...
// AirSim/AirLib/include/common/common_utils/EnumFlags.hpp

#ifndef BUBBLEFS_UTILS_AIRSIM_ENUM_FLAGS_H_
#define BUBBLEFS_UTILS_AIRSIM_ENUM_FLAGS_H_
...
#endif // BUBBLEFS_UTILS_AIRSIM_ENUM_FLAGS_H_
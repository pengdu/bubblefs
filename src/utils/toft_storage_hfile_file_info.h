...
// toft/storage/sstable/hfile/file_info.h

#ifndef BUBBLEFS_UTILS_TOFT_STORAGE_HFILE_FILE_INFO_H_
#define BUBBLEFS_UTILS_TOFT_STORAGE_HFILE_FILE_INFO_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_STORAGE_HFILE_FILE_INFO_H_
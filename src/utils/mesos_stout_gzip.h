...
// mesos/3rdparty/stout/include/stout/gzip.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_GZIP_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_GZIP_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_GZIP_H_
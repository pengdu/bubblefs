...
#define BUBBLEFS_UTILS_BRPC_POOLED_MAP_H_
...
namespace std {
template <class T1, size_t BLOCK_SIZE>
inline void swap(::bubblefs::brpc::details::PooledAllocator<T1, BLOCK_SIZE> &lhs,
                 ::bubblefs::brpc::details::PooledAllocator<T1, BLOCK_SIZE> &rhs){
    lhs.swap(rhs);
}
}  // namespace std

#endif  // BUBBLEFS_UTILS_BRPC_POOLED_MAP_H_
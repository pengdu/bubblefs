...
// Pebble/src/framework/router.cpp

#include "utils/pebble_router.h"
...
int32_t Router::Init(Naming* naming)
{
    ...
    m_naming = naming;
    WatchFunc cob = std::bind(&Router::NameWatch, this, std::placeholders::_1);
...
int32_t Router::SetRoutePolicy(RoutePolicyType policy_type, IRoutePolicy* policy)
{
    ...
    case kROUND_ROUTE:
        policy = new RoundRoutePolicy;
        break;
    case kMOD_ROUTE:
        policy = new ModRoutePolicy;
        break;
    default:
        return kROUTER_INVAILD_PARAM;
    }

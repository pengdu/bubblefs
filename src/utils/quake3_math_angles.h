...
// Quake-III-Arena/code/splines/math_angles.h

#ifndef BUBBLEFS_UTILS_QUAKE3_MATH_ANGLES_H_
#define BUBBLEFS_UTILS_QUAKE3_MATH_ANGLES_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_MATH_ANGLES_H_
...
#ifndef BUBBLEFS_UTILS_POOLED_MAP_H_
#define BUBBLEFS_UTILS_POOLED_MAP_H_

#include <new>
#include <map>
#include "utils/single_threaded_pool.h"
...
namespace std {
template <class T1, size_t BLOCK_SIZE>
inline void swap(::bubblefs::base::details::PooledAllocator<T1, BLOCK_SIZE> &lhs,
                 ::bubblefs::base::details::PooledAllocator<T1, BLOCK_SIZE> &rhs){
    lhs.swap(rhs);
}
}  // namespace std

#endif  // BUBBLEFS_UTILS_POOLED_MAP_H_
...
#ifndef  BUBBLEFS_UTILS_BDCOMMON_COUNTER_H_
#define  BUBBLEFS_UTILS_BDCOMMON_COUNTER_H_

#include "platform/bdcommon_atomic.h"
...
#endif  // BUBBLEFS_UTILS_BDCOMMON_COUNTER_H_
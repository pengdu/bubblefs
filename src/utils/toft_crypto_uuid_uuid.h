...
// toft/crypto/uuid/uuid.h

#ifndef BUBBLEFS_UTILS_TOFT_CRYPTO_UUID_UUID_H_
#define BUBBLEFS_UTILS_TOFT_CRYPTO_UUID_UUID_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_CRYPTO_UUID_UUID_H_
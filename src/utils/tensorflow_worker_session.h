...
// tensorflow/tensorflow/core/distributed_runtime/worker_session.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_WORKER_SESSION_H_
#define BUBBLEFS_UTILS_TENSORFLOW_WORKER_SESSION_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_WORKER_SESSION_H_
...
#include "utils/klayge_kfl_cpuinfo.h"
#include <array>
#include <vector>
...
#if (defined(ARCH_CPU_X86) || defined(ARCH_CPU_X86_64)) && !defined(OS_ANDROID)
...
#endif  //  TODO: Supports other arch
        } // CPUInfo

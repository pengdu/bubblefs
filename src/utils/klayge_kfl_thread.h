...
// KlayGE/KFL/include/KFL/Thread.hpp

#ifndef BUBBLEFS_UTILS_KLAYGE_KFL_THREAD_H_
#define BUBBLEFS_UTILS_KLAYGE_KFL_THREAD_H_
...
#endif // BUBBLEFS_UTILS_KLAYGE_KFL_THREAD_H_
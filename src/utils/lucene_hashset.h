...
#ifndef BUBBLEFS_UTILS_LUCENE_HASHSET_H_
#define BUBBLEFS_UTILS_LUCENE_HASHSET_H_
...
class HashSet : public ObjectSync {
public:
...
public:
    static this_type newInstance() {
        this_type instance;
        instance.setContainer = mylucene::newInstance<set_type>();
        return instance;
    }
    ...
    static this_type newInstance(ITER first, ITER last) {
        this_type instance;
        instance.setContainer = mylucene::newInstance<set_type>(first, last);
        return instance;
    }
...
#endif // BUBBLEFS_UTILS_LUCENE_HASHSET_H_
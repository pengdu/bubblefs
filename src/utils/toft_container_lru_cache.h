...
// toft/container/lru_cache.h

#ifndef BUBBLEFS_UTILS_TOFT_CONTAINER_LRU_CACHE_H_
#define BUBBLEFS_UTILS_TOFT_CONTAINER_LRU_CACHE_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_CONTAINER_LRU_CACHE_H_
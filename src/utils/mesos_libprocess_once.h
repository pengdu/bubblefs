...
// mesos/3rdparty/libprocess/include/process/once.hpp

#ifndef BUBBLEFS_UTILS_MESOS_PROCESS_ONCE_H_
#define BUBBLEFS_UTILS_MESOS_PROCESS_ONCE_H_
...
#endif // BUBBLEFS_UTILS_MESOS_PROCESS_ONCE_H_
...
// Teaf/trunk/teaf(isgw)/comm/lua_oper.h

#ifndef BUBBLEFS_UTILS_TEAF_LUA_OPER_H_
#define BUBBLEFS_UTILS_TEAF_LUA_OPER_H_
...
typedef std::map<unsigned int, lua_State *> LUA_STATE_MAP;
...
#endif // BUBBLEFS_UTILS_TEAF_LUA_OPER_H_
...
// mesos/3rdparty/stout/include/stout/recordio.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_RECORDIO_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_RECORDIO_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_RECORDIO_H_
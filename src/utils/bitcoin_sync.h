...
#ifndef BUBBLEFS_UTILS_BITCOIN_SYNC_H_
#define BUBBLEFS_UTILS_BITCOIN_SYNC_H_
...
void inline AssertLockHeldInternal(const char* pszName, const char* pszFile, int nLine, void* cs) {}

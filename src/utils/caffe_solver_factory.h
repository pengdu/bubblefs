...
#ifndef BUBBLEFS_UTILS_CAFFE_SOLVER_FACTORY_H_
#define BUBBLEFS_UTILS_CAFFE_SOLVER_FACTORY_H_
...
class SolverRegistry {
 public:
  ...
  static std::vector<string> SolverTypeList() {
    CreatorRegistry& registry = Registry();
    std::vector<string> solver_types;
 ...
 private:
  ...
  static string SolverTypeListString() {
    std::vector<string> solver_types = SolverTypeList();
    string solver_types_str;
    for (std::vector<string>::iterator iter = solver_types.begin();
...
#endif  // BUBBLEFS_UTILS_CAFFE_SOLVER_FACTORY_H_
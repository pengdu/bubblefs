...
// tensorflow/tensorflow/core/distributed_runtime/worker_interface.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_WORKER_INTERFACE_H_
#define BUBBLEFS_UTILS_TENSORFLOW_WORKER_INTERFACE_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_WORKER_INTERFACE_H_
...
// Quake-III-Arena/code/splines/math_matrix.h

#ifndef BUBBLEFS_UTILS_QUAKE3_MATH_MATRIX_H_
#define BUBBLEFS_UTILS_QUAKE3_MATH_MATRIX_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_MATH_MATRIX_H_
...
#ifndef BUBBLEFS_UTILS_AIRSIM_MEDIAN_FILTER_H_
#define BUBBLEFS_UTILS_AIRSIM_MEDIAN_FILTER_H_

// AirSim/AirLib/include/common/common_utils/MedianFilter.hpp
...
#endif // BUBBLEFS_UTILS_AIRSIM_MEDIAN_FILTER_H_
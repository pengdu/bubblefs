...
// LucenePlusPlus/include/MiscUtils.h

#ifndef BUBBLEFS_UTILS_LUCENE_MISCUTILS_H_
#define BUBBLEFS_UTILS_LUCENE_MISCUTILS_H_
...
public:
    ...
    template <typename TYPE>
    static bool typeOf(const ObjectPtr& object) {
        return std::dynamic_pointer_cast<TYPE>(object).get() != NULL;
    }

    /// Return whether given Lucene objects are of equal type.
    static bool equalTypes(const ObjectPtr& first, const ObjectPtr& second);
...
#endif // BUBBLEFS_UTILS_LUCENE_MISCUTILS_H_
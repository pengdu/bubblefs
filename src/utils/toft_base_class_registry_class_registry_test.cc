...
// toft/base/class_registry/class_registry_test.cpp

#include "toft_base_class_registry_class_registry.h"
#include <set>
#include "utils/toft_base_class_registry_class_registry_test_helper.h"
...
MYTOFT_CLASS_REGISTRY_DEFINE(some_class_registry, SomeClass);
...
#define CREATE_SOME_CLASS(name_as_string) \
    MYTOFT_CLASS_REGISTRY_CREATE_OBJECT(base_namespace::some_class_registry, name_as_string)

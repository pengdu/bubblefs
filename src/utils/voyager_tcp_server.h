...
// voyager/voyager/core/tcp_server.h

#ifndef BUBBLEFS_UTILS_VOYAGER_TCP_SERVER_H_
#define BUBBLEFS_UTILS_VOYAGER_TCP_SERVER_H_
...
#endif  // BUBBLEFS_UTILS_VOYAGER_TCP_SERVER_H_
...
// apollo/modules/common/math/euler_angles_zxy.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_EULER_ANGLES_ZXY_H_
#define BUBBLEFS_UTILS_APOLLO_EULER_ANGLES_ZXY_H_
...
#endif // BUBBLEFS_UTILS_APOLLO_EULER_ANGLES_ZXY_H_
...
// mars/mars/comm/move_wrapper.h

#ifndef BUBBLEFS_UTILS_MARS_MOVE_WRAPPER_H_
#define BUBBLEFS_UTILS_MARS_MOVE_WRAPPER_H_
...
#endif  // BUBBLEFS_UTILS_MARS_MOVE_WRAPPER_H_
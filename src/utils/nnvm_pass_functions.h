...
#ifndef BUBBLEFS_UTILS_NNVM_PASS_FUNCTIONS_H_
#define BUBBLEFS_UTILS_NNVM_PASS_FUNCTIONS_H_
...
#include "utils/nnvm_graph_attr_types.h"
...
#endif  // BUBBLEFS_UTILS_NNVM_PASS_FUNCTIONS_H_
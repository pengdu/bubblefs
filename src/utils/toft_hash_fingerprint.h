...
// toft/hash/fingerprint.h

#ifndef BUBBLEFS_UTILS_TOFT_HASH_FINGERPRINT_H_
#define BUBBLEFS_UTILS_TOFT_HASH_FINGERPRINT_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_HASH_FINGERPRINT_H_
...
// peloton/src/include/common/item_pointer.h

#ifndef BUBBLEFS_UTILS_PELOTON_ITEM_POINTER_H_
#define BUBBLEFS_UTILS_PELOTON_ITEM_POINTER_H_
...
#endif // BUBBLEFS_UTILS_PELOTON_ITEM_POINTER_H_
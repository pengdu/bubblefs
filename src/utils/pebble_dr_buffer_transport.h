...
// Pebble/src/framework/dr/transport/buffer_transport.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_BUFFER_TRANSPORT_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_BUFFER_TRANSPORT_H_
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_BUFFER_TRANSPORT_H_
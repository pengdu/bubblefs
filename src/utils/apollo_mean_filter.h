...
// apollo/modules/control/filters/mean_filter.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_MEAN_FILTER_H_
#define BUBBLEFS_UTILS_APOLLO_MEAN_FILTER_H_
...
#endif  // BUBBLEFS_UTILS_APOLLO_MEAN_FILTER_H_
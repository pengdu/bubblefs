...
// Pebble/src/framework/rpc_util.cpp

#include "utils/pebble_rpc_util.h"
...
void RpcUtil::SendRequestInCoroutine(int64_t handle,
    ...
    OnRpcResponse rsp = std::bind(&RpcUtil::OnResponse, this,
        std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, co_id);
...
void RpcUtil::SendRequestParallelInCoroutine(int64_t handle,
                                             ...
                                             uint32_t* num_parallel) {
    int64_t co_id = m_coroutine_schedule->CurrentTaskId();
    OnRpcResponse rsp = std::bind(&RpcUtil::OnResponseParallel, this,
                                  std::placeholders::_1,
                                  std::placeholders::_2,
                                  std::placeholders::_3,
                                  ret_code,
...
int32_t RpcUtil::ProcessRequest(int64_t handle, const RpcHead& rpc_head,
    ...
    std::function<void(void)> run = std::bind(&RpcUtil::ProcessRequestInCoroutine, this,

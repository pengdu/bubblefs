...
// toft/storage/path/path.h

#ifndef BUBBLEFS_UTILS_TOFT_STORAGE_PATH_PATH_H_
#define BUBBLEFS_UTILS_TOFT_STORAGE_PATH_PATH_H_
...
#endif // BUBBLEFS_UTILS_TOFT_STORAGE_PATH_PATH_H_
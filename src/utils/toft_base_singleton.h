...
// toft/base/singleton.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_SINGLETON_H_
#define BUBBLEFS_UTILS_TOFT_BASE_SINGLETON_H_
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_SINGLETON_H_
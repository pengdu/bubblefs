...
// apollo/modules/perception/lib/base/concurrent_queue.h

#ifndef BUBBLEFS_UTILS_APOLLO_CONCURRENT_QUEUE_H_
#define BUBBLEFS_UTILS_APOLLO_CONCURRENT_QUEUE_H_

#include <queue>

#include "platform/apollo_mutex.h"
...
#endif  // BUBBLEFS_UTILS_APOLLO_CONCURRENT_QUEUE_H_
...
// Pebble/src/framework/dr/common/fp_util.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_FP_UTIL_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_FP_UTIL_H_

#include <limits>

namespace bubblefs {
namespace mypebble { namespace dr { namespace floating_point {
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_FP_UTIL_H_
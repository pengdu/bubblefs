...
// Paddle/paddle/utils/ClassRegistrar.h

#ifndef BUBBLEFS_UTILS_PADDLE_CALSS_REGISTRAR_H_
#define BUBBLEFS_UTILS_PADDLE_CALSS_REGISTRAR_H_
...
public:
  ...
  BaseClass* createByType(const std::string& type, CreateArgs... args) {
    ...
    mapGet(type, creatorMap_, &creator);
    return creator(args...);
  }
...
#endif // BUBBLEFS_UTILS_PADDLE_CALSS_REGISTRAR_H_
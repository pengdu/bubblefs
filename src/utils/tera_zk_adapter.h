...
// tera/src/zk/zk_adapter.h
// tera/src/zk/dummy_zk_adapter.h

#ifndef  BUBBLEFS_UTILS_TERA_ZK_ADAPTER_H_
#define  BUBBLEFS_UTILS_TERA_ZK_ADAPTER_H_
...
private:
    ...
    static port::Mutex lib_log_mutex_;
    ...
    port::CondVar state_cond_;
    uint32_t session_timeout_;
    int64_t session_timer_id_;
    mybdcom::ThreadPool thread_pool_;
...
#endif  // BUBBLEFS_UTILS_TERA_ZK_ADAPTER_H_
...
// toft/base/string/algorithm.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_STRING_ALGORITHM_H_
#define BUBBLEFS_UTILS_TOFT_BASE_STRING_ALGORITHM_H_
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_STRING_ALGORITHM_H_
...
// brpc/src/butil/synchronous_event.h

#ifndef BUBBLEFS_UTILS_SYNCHRONOUS_EVENT_H_
#define BUBBLEFS_UTILS_SYNCHRONOUS_EVENT_H_
...
#endif  // BUBBLEFS_UTILS_SYNCHRONOUS_EVENT_H_
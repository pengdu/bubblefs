...
// AirSim/AirLib/include/common/common_utils/ProsumerQueue.hpp

#ifndef BUBBLEFS_UTILS_AIRSIM_PROSUMER_QUEUE_H_
#define BUBBLEFS_UTILS_AIRSIM_PROSUMER_QUEUE_H_
...
#endif // BUBBLEFS_UTILS_AIRSIM_PROSUMER_QUEUE_H_
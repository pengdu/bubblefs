...
// tensorflow/tensorflow/core/lib/gtl/priority_queue_util.h

#ifndef BUBBLEFS_UTILS_PRIORITY_QUEUE_UTIL_H_
#define BUBBLEFS_UTILS_PRIORITY_QUEUE_UTIL_H_
...
#endif  // BUBBLEFS_UTILS_PRIORITY_QUEUE_UTIL_H_
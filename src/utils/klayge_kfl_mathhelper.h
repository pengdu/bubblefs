...
// KlayGE/KFL/include/KFL/Detail/MathHelper.hpp

#ifndef BUBBLEFS_UTIILS_KLAYGE_KFL_MATHHELPER_H_
#define BUBBLEFS_UTIILS_KLAYGE_KFL_MATHHELPER_H_
...
#endif // BUBBLEFS_UTIILS_KLAYGE_KFL_MATHHELPER_H_
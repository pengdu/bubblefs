...
// tensorflow/tensorflow/core/lib/core/status_test_util.h

#ifndef BUBBLEFS_UTILS_STATUS_TEST_UTIL_H_
#define BUBBLEFS_UTILS_STATUS_TEST_UTIL_H_
...
#define TF_EXPECT_OK(statement) \
  EXPECT_EQ(::bubblefs::Status::OK(), (statement))
#define TF_ASSERT_OK(statement) \
  ASSERT_EQ(::bubblefs::Status::OK(), (statement))
...
#endif  // BUBBLEFS_UTILS_STATUS_TEST_UTIL_H_
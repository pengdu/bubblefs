...
// tensorflow/tensorflow/core/graph/algorithm.h

#ifndef BUBBLEFS_UTILS_GRAPH_ALGORITHM_H_
#define BUBBLEFS_UTILS_GRAPH_ALGORITHM_H_
...
#endif  // BUBBLEFS_UTILS_GRAPH_ALGORITHM_H_
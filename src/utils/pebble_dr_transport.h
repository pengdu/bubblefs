...
// Pebble/src/framework/dr/transport/transport.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_TTRANSPORT_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_TTRANSPORT_H_
...
public:
    ...
    virtual uint32_t readAll_virt(uint8_t* buf, uint32_t len) {
        return dr::transport::readAll(*this, buf, len);
    }
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_TTRANSPORT_H_
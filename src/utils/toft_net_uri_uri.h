...
#ifndef BUBBLEFS_UTILS_TOFT_NET_URI_URI_H_
#define BUBBLEFS_UTILS_TOFT_NET_URI_URI_H_
...
template <>
inline void swap(::bubblefs::mytoft::UriAuthority& x, ::bubblefs::mytoft::UriAuthority& y)
{
    x.Swap(&y);
}

template <>
inline void swap(::bubblefs::mytoft::URI& x, ::bubblefs::mytoft::URI& y)
{
    x.Swap(&y);
}
...
#endif // BUBBLEFS_UTILS_TOFT_NET_URI_URI_H_
...
// mesos/3rdparty/stout/include/stout/os/strerror.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_OS_STRERROR_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_OS_STRERROR_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_OS_STRERROR_H_
...
// SeetaFaceEngine/FaceDetection/include/util/math_func.h

#ifndef BUBBLEFS_UTILS_SEETA_MATH_FUNC_H_
#define BUBBLEFS_UTILS_SEETA_MATH_FUNC_H_
...
#endif  // BUBBLEFS_UTILS_SEETA_MATH_FUNC_H_
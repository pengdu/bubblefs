...
// mesos/3rdparty/stout/include/stout/result.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_RESULT_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_RESULT_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_RESULT_H_
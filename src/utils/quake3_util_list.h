...
// Quake-III-Arena/code/splines/util_list.h

#ifndef BUBBLEFS_UTILS_QUAKE3_UTIL_LIST_H_
#define BUBBLEFS_UTILS_QUAKE3_UTIL_LIST_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_UTIL_LIST_H_
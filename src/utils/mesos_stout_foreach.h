...
// mesos/3rdparty/stout/include/stout/foreach.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_FOREACH_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_FOREACH_H_

#include <tuple>
#include <utility>
#include "utils/mesos_stout_attributes.h"
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_FOREACH_H_
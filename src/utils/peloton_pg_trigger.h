...
// peloton/src/include/parser/pg_trigger.h

#ifndef BUBBLEFS_UTILS_PELOTON_PG_TRIGGER_H_
#define BUBBLEFS_UTILS_PELOTON_PG_TRIGGER_H_
...
#endif   // BUBBLEFS_UTILS_PELOTON_PG_TRIGGER_H_
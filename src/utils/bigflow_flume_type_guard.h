...
// bigflow/flume/util/type_guard.h

#ifndef BUBBLEFS_UTILS_BIGFLOW_FLUME_TYPE_GUARD_H_
#define BUBBLEFS_UTILS_BIGFLOW_FLUME_TYPE_GUARD_H_
...
public:
    static T* Cast(void* ptr) {
        ...
        assert(result->m_magic == &s_type_identity); // "Given pointer has wrong type: " << ptr;
        return result;
    }
...
#endif  // BUBBLEFS_UTILS_BIGFLOW_FLUME_TYPE_GUARD_H_
...
// mesos/3rdparty/stout/include/stout/try.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_TRY_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_TRY_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_TRY_H_
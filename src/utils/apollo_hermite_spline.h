...
// apollo/modules/planning/math/hermite_spline.h

/**
 * @file
 **/

#ifndef BUBBLEFS_UTILS_APOLLO_HERMITE_SPLINE_H_
#define BUBBLEFS_UTILS_APOLLO_HERMITE_SPLINE_H_
...
inline T HermiteSpline<T, N>::Evaluate(const std::uint32_t order,
  ...
  PANIC_ENFORCE_LE(z0_, z);
  PANIC_ENFORCE_LE(z, z0_ + delta_z_);
...
#endif  // BUBBLEFS_UTILS_APOLLO_HERMITE_SPLINE_H_
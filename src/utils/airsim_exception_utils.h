...
// AirSim/AirLib/include/common/common_utils/ExceptionUtils.hpp

#ifndef BUBBLEFS_UTILS_AIRSIM_EXCEPTION_UTILS_H_
#define BUBBLEFS_UTILS_AIRSIM_EXCEPTION_UTILS_H_
...
#endif // BUBBLEFS_UTILS_AIRSIM_EXCEPTION_UTILS_H_
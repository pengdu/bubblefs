...
// mesos/3rdparty/stout/include/stout/proc.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_PROC_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_PROC_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_PROC_H_
...
// Pebble/tools/compiler/pb/src/cpp_plugin.cpp
...
public:
    ...
    std::shared_ptr<const Method> method(int i) const {
        return std::shared_ptr<const Method>(new ProtoBufMethod(service_->method(i)));
    }
...
public:
    ...
    std::shared_ptr<const Service> service(int i) const {
        return std::shared_ptr<const Service>(new ProtoBufService(file_->service(i)));
    }

    std::shared_ptr<Printer> CreatePrinter(std::string *str) const {
        return std::shared_ptr<Printer>(new ProtoBufPrinter(str));
    }
...
public:
    ...
    virtual bool Generate(const google::protobuf::FileDescriptor* file,
        ...
        std::shared_ptr<google::protobuf::io::ZeroCopyOutputStream> inheader_output(
        ...
        std::shared_ptr<google::protobuf::io::ZeroCopyOutputStream> header_output(
        ...
        std::shared_ptr<google::protobuf::io::ZeroCopyOutputStream> source_output(
...
int main(int argc, char *argv[]) {
    bubblefs::mypebble::CppServiceGenerator generator;

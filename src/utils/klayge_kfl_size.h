...
// KlayGE/KFL/include/KFL/Size.hpp

#ifndef BUBBLEFS_UTILS_KLAYGE_KFL_SIZE_H_
#define BUBBLEFS_UTILS_KLAYGE_KFL_SIZE_H_
...
#endif // BUBBLEFS_UTILS_KLAYGE_KFL_SIZE_H_
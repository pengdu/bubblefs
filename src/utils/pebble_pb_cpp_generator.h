...
// Pebble/tools/compiler/pb/src/cpp_generator.h

#ifndef BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_H_
#define BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_H_
...
public:
  ...
  virtual std::shared_ptr<const Method> method(int i) const = 0;
};
...
public:
    ...
    virtual std::shared_ptr<const Service> service(int i) const = 0;

    virtual std::shared_ptr<Printer> CreatePrinter(std::string* str) const = 0;
};
...
#endif  // BUBBLEFS_UTILS_PEBBLE_PB_CPP_GENERATOR_H_
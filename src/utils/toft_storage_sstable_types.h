...
// toft/storage/sstable/types.h

#ifndef BUBBLEFS_UTILS_TOFT_STORAGE_SSTABLE_TYPES_H_
#define BUBBLEFS_UTILS_TOFT_STORAGE_SSTABLE_TYPES_H_
...
#endif  // BUBBLEFS_UTILS_TOFT_STORAGE_SSTABLE_TYPES_H_
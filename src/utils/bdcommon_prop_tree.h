...
// tera/src/utils/prop_tree.h

#ifndef BUBBLEFS_UTILS_BCOMMON_PROP_TREE_H_
#define BUBBLEFS_UTILS_BCOMMON_PROP_TREE_H_
...
#endif // BUBBLEFS_UTILS_BCOMMON_PROP_TREE_H_
...
#ifndef BUBBLEFS_UTILS_OPENCC_UTF8_UTIL_H_
#define BUBBLEFS_UTILS_OPENCC_UTF8_UTIL_H_

#include <vector>
#include "platform/types.h"
#include "utils/opencc_exception.h"
...
#endif // BUBBLEFS_UTILS_OPENCC_UTF8_UTIL_H_
...
// LucenePlusPlus/include/HashMap.h

#ifndef BUBBLEFS_UTILS_LUCENE_HASHMAP_H_
#define BUBBLEFS_UTILS_LUCENE_HASHMAP_H_
...
class HashMap : public ObjectSync {
public:
...
public:
    static this_type newInstance() {
        this_type instance;
        instance.mapContainer = mylucene::newInstance<map_type>();
        return instance;
    }
...
#endif // BUBBLEFS_UTILS_LUCENE_HASHMAP_H_
...
// mesos/3rdparty/stout/include/stout/format.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_FORMAT_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_FORMAT_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_FORMAT_H_
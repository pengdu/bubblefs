...
#ifndef BUBBLEFS_UTILS_BITCOIN_DBWRAPPER_H_
#define BUBBLEFS_UTILS_BITCOIN_DBWRAPPER_H_
...
static const int CLIENT_VERSION = 1000;  
...
#endif // BUBBLEFS_UTILS_BITCOIN_DBWRAPPER_H_
...
// ps-lite/include/ps/internal/parallel_kv_match.h

#ifndef BUBBLEFS_UTILS_PSLITE_PARALLEL_KV_MATCH_H_
#define BUBBLEFS_UTILS_PSLITE_PARALLEL_KV_MATCH_H_

#include <thread>
#include <algorithm>
#include "utils/pslite_assign_op.h"
...
size_t ParallelOrderedMatch(
  ...
  // do check
  PANIC_ENFORCE_GT(num_threads, 0);
  PANIC_ENFORCE_EQ(src_key.size() * k, src_val.size());
...
#endif  // BUBBLEFS_UTILS_PSLITE_PARALLEL_KV_MATCH_H_
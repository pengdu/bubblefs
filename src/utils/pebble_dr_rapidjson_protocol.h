...
// Pebble/src/framework/dr/protocol/rapidjson_protocol.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_RAPIDJSON_PROTOCOL_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_RAPIDJSON_PROTOCOL_H_
...
struct LookaheadStream {
    ...
    LookaheadStream(std::shared_ptr<dr::transport::TTransport> tran) : tran_(tran) {
        Reset();
    }
    ...
    std::shared_ptr<dr::transport::TTransport> tran_;
...
class TRAPIDJSONProtocol : public TVirtualProtocol<TRAPIDJSONProtocol> {
 public:
  ...
  TRAPIDJSONProtocol(std::shared_ptr<TTransport> ptrans);
 ...
 private:
  ...
  std::stack<std::shared_ptr<TraverseContext> > contexts_stack_;
...
class TRAPIDJSONProtocolFactory : public TProtocolFactory {
 public:
  ...
  std::shared_ptr<TProtocol> getProtocol(std::shared_ptr<TTransport> trans) {
    return std::shared_ptr<TProtocol>(new TRAPIDJSONProtocol(trans));
  }
};
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_RAPIDJSON_PROTOCOL_H_
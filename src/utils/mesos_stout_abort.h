...
// mesos/3rdparty/stout/include/stout/abort.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_ABORT_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_ABORT_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_ABORT_H_
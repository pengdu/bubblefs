...
// xlearn/src/base/format_print.h
...
#ifndef BUBBLEFS_UTILS_XLEARN_FORMAT_PRINT_H_
#define BUBBLEFS_UTILS_XLEARN_FORMAT_PRINT_H_
...
#endif  // BUBBLEFS_UTILS_XLEARN_FORMAT_PRINT_H_
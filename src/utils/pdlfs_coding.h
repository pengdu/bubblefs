...
// pdlfs-common/include/pdlfs-common/coding.h

#ifndef BUBBLEFS_UTILS_PDLFS_CODING_H_
#define BUBBLEFS_UTILS_PDLFS_CODING_H_
...
#endif // BUBBLEFS_UTILS_PDLFS_CODING_H_
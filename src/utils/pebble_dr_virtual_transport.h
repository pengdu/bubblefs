...
// Pebble/src/framework/dr/transport/virtual_transport.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_TRANSPORT_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_TRANSPORT_H_
...
public:
    ...
    uint32_t readAll(uint8_t* buf, uint32_t len) {
        ...
        return dr::transport::readAll(*trans, buf, len);
    }
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_VIRTUAL_TRANSPORT_H_
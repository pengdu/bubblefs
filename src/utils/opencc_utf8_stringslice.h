...
// OpenCC/src/UTF8StringSlice.hpp

#ifndef BUBBLEFS_UTILS_OPENCC_UTF8_STRINGSLICE_H_
#define BUBBLEFS_UTILS_OPENCC_UTF8_STRINGSLICE_H_
...
#endif // BUBBLEFS_UTILS_OPENCC_UTF8_STRINGSLICE_H_
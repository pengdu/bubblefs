...
// AirSim/AirLib/include/common/common_utils/StrictMode.hpp

#ifndef BUBBLEFS_UTILS_AIRSIM_STRICT_MODE_H_
#define BUBBLEFS_UTILS_AIRSIM_STRICT_MODE_H_
...
#endif // BUBBLEFS_UTILS_AIRSIM_STRICT_MODE_H_
...
// caffe2/caffe2/core/blob.h

#ifndef BUBBLEFS_UTILS_CAFFE2_BLOB_H_
#define BUBBLEFS_UTILS_CAFFE2_BLOB_H_
 ...
 public:
  ...
  T* GetMutable(bool* is_new_object=nullptr) {
    if (IsType<T>()) {
      ...
      PRINTF_INFO("Create new mutable object %s\n", TypeMeta::Name<T>());
...
#endif  // BUBBLEFS_UTILS_CAFFE2_BLOB_H_
...
// Quake-III-Arena/code/splines/math_vector.h

#ifndef BUBBLEFS_UTILS_QUAKE3_MATH_VECTOR_H_
#define BUBBLEFS_UTILS_QUAKE3_MATH_VECTOR_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_MATH_VECTOR_H_
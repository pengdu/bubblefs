...
// brpc/src/butil/containers/bounded_queue.h

#ifndef BUBBLEFS_UTILS_BOUNDED_QUEUE_H_
#define BUBBLEFS_UTILS_BOUNDED_QUEUE_H_
...
#endif  // BUBBLEFS_UTILS_BOUNDED_QUEUE_H_
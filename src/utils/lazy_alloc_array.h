...
// incubator-mxnet/src/common/lazy_alloc_array.h

#ifndef BUBBLEFS_UTILS_LAZY_ALLOC_ARRAY_H_
#define BUBBLEFS_UTILS_LAZY_ALLOC_ARRAY_H_
...
#endif  // BUBBLEFS_UTILS_LAZY_ALLOC_ARRAY_H_
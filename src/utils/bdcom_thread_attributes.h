...
// tera/src/common/thread_attributes.h

#ifndef BUBBLEFS_UTILS_BDCOM_THREAD_ATTRIBUTES_H_
#define BUBBLEFS_UTILS_BDCOM_THREAD_ATTRIBUTES_H_
...
#endif // BUBBLEFS_UTILS_BDCOM_THREAD_ATTRIBUTES_H_
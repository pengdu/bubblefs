...
// Quake-III-Arena/code/splines/math_quaternion.cpp

#include "utils/quake3_math_quaternion.h"
#include "utils/quake3_math_angles.h"
#include "utils/quake3_math_matrix.h"

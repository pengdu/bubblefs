...
// Paddle/paddle/framework/threadpool.h

#ifndef BUBBLEFS_UTILS_PADDLE_THREADPOOL_H_
#define BUBBLEFS_UTILS_PADDLE_THREADPOOL_H_
...
#endif // BUBBLEFS_UTILS_PADDLE_THREADPOOL_H_
...
// brpc/src/butil/scoped_lock.h

#ifndef BUBBLEFS_UTILS_SCOPED_LOCK_H_
#define BUBBLEFS_UTILS_SCOPED_LOCK_H_
...
#define BASE_SCOPED_LOCK(ref_of_lock)                                  \
    decltype(::bubblefs::base::detail::get_lock_guard<decltype(ref_of_lock)>()) \
    BASE_CONCAT(scoped_locker_dummy_at_line_, __LINE__)(ref_of_lock)
#endif
...
#endif  // BUBBLEFS_UTILS_SCOPED_LOCK_H_
...
// Pebble/src/server/pebble_cmdline.h

#ifndef  BUBBLEFS_UTILS_PEBBLE_CMDLINE_H_
#define  BUBBLEFS_UTILS_PEBBLE_CMDLINE_H_
...
#endif // BUBBLEFS_UTILS_PEBBLE_CMDLINE_H_
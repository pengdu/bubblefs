...
// mesos/3rdparty/stout/include/stout/hashset.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_HASHSET_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_HASHSET_H_
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_HASHSET_H_
...
#ifndef BUBBLEFS_UTILS_NNVM_PASS_H_
#define BUBBLEFS_UTILS_NNVM_PASS_H_
...
struct PassFunctionReg
    : public mydmlc::FunctionRegEntryBase<PassFunctionReg,
                                        PassFunction> {
  /*!
...
#define NNVM_REGISTER_PASS(name)                                     \
  DMLC_REGISTRY_REGISTER(::bubblefs::mynnvm::PassFunctionReg, PassFunctionReg, name)

}  // namespace mynnvm
}  // namespace bubblefs

#endif  // BUBBLEFS_UTILS_NNVM_PASS_H_
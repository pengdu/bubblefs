...
// xlearn/src/base/class_register.h
...
#ifndef BUBBLEFS_UTILS_XLEARN_CLASS_REGISTER_H_
#define BUBBLEFS_UTILS_XLEARN_CLASS_REGISTER_H_
...
#endif  // BUBBLEFS_UTILS_XLEARN_CLASS_REGISTER_H_
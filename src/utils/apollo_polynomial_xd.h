...
// apollo/modules/planning/math/polynomial_xd.h

/**
 * @file: polynomial_xd.h
 **/

#ifndef BUBBLEFS_UTILS_APOLLO_POLYNOMIAL_XD_H_
#define BUBBLEFS_UTILS_APOLLO_POLYNOMIAL_XD_H_
...
#endif  // BUBBLEFS_UTILS_APOLLO_POLYNOMIAL_XD_H_
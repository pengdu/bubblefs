...
// toft/base/unique_ptr.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_UNIQUE_PTR_H_
#define BUBBLEFS_UTILS_TOFT_BASE_UNIQUE_PTR_H_
...
using bubblefs::mytoft::default_delete;
using bubblefs::mytoft::unique_ptr;
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_UNIQUE_PTR_H_
...
// Quake-III-Arena/code/splines/math_quaternion.h

#ifndef BUBBLEFS_UTILS_QUAKE3_MATH_QUATERNION_H_
#define BUBBLEFS_UTILS_QUAKE3_MATH_QUATERNION_H_
...
#endif // BUBBLEFS_UTILS_QUAKE3_MATH_QUATERNION_H_
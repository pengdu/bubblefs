...
// Pebble/src/common/thread_pool.h

#ifndef BUBBLEFS_UTILS_PEBBLE_THREAD_POOL_H_
#define BUBBLEFS_UTILS_PEBBLE_THREAD_POOL_H_
...
#include "utils/pebble_blocking_queue.h"
...
public:
    ...
    //
    /// @return 0: 成功 其他: 失败
    int AddTask(std::function<void()>& fun, int64_t task_id = -1);

...
// Paddle/paddle/string/piece_test.cc

#include "utils/paddle_string_piece.h"
...
TEST(StringPiece, Construct) {
  {
    bubblefs::mypaddle::string::Piece s;
    EXPECT_EQ(NULL, s.data());
    EXPECT_EQ(0U, s.len());
  }
  {
    EXPECT_THROW(bubblefs::mypaddle::string::Piece s(NULL, 10000U), std::invalid_argument);
  }
  {
    bubblefs::mypaddle::string::Piece s(NULL);
    EXPECT_EQ(0U, s.len());
  }
  {
    std::string a;
    EXPECT_EQ(0U, a.size());
    bubblefs::mypaddle::string::Piece s(a);
    EXPECT_EQ(0U, s.len());
  }
}

TEST(StringPiece, CopyAndAssign) {
  bubblefs::mypaddle::string::Piece empty;
  EXPECT_EQ(0U, empty.len());

  bubblefs::mypaddle::string::Piece a("hello");
  bubblefs::mypaddle::string::Piece b = a;
  EXPECT_EQ(b.len(), strlen("hello"));
  EXPECT_EQ(a, b);

  std::string storage("hello");
  bubblefs::mypaddle::string::Piece c(storage);
  EXPECT_EQ(a, c);
...
TEST(StringPiece, Compare) {
  {
    bubblefs::mypaddle::string::Piece a("hello");
    bubblefs::mypaddle::string::Piece b("world");
    EXPECT_TRUE(a != b);
    EXPECT_FALSE(a == b);
    EXPECT_TRUE(a < b);
    EXPECT_TRUE(a <= b);
  ...
  {
    bubblefs::mypaddle::string::Piece a, b;
    EXPECT_TRUE(a == b);
    EXPECT_FALSE(a != b);
    EXPECT_FALSE(a < b);
    EXPECT_FALSE(a > b);
...
TEST(StringPiece, ToString) {
  ...
  {
    bubblefs::mypaddle::string::Piece s("hello");
    EXPECT_EQ(std::string("hello"), s.ToString());
  }
}

TEST(StringPiece, HasPrefixSuffix) {
  using bubblefs::mypaddle::string::HasPrefix;
  using bubblefs::mypaddle::string::HasSuffix;
  {
    bubblefs::mypaddle::string::Piece s;
  ...
  {
    bubblefs::mypaddle::string::Piece s("app");
    EXPECT_TRUE(HasPrefix(s, ""));
...
TEST(StringPiece, SkipPrefixSuffix) {
  using bubblefs::mypaddle::string::SkipPrefix;
  using bubblefs::mypaddle::string::SkipSuffix;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, TrimPrefixSuffix) {
  using bubblefs::mypaddle::string::TrimPrefix;
  using bubblefs::mypaddle::string::TrimSuffix;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, Contains) {
  using bubblefs::mypaddle::string::Contains;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, Index) {
  using bubblefs::mypaddle::string::Index;
  auto npos = bubblefs::mypaddle::string::Piece::npos;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, Find) {
  using bubblefs::mypaddle::string::Find;
  auto npos = bubblefs::mypaddle::string::Piece::npos;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, RFind) {
  using bubblefs::mypaddle::string::RFind;
  auto npos = bubblefs::mypaddle::string::Piece::npos;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, SubStr) {
  using bubblefs::mypaddle::string::SubStr;
  {
    bubblefs::mypaddle::string::Piece s;
...
TEST(StringPiece, StreamOutput) {
  using bubblefs::mypaddle::string::Piece;

  std::stringstream o;
  o << bubblefs::mypaddle::string::Piece();
  EXPECT_EQ("", o.str());

  o << bubblefs::mypaddle::string::Piece("hello");

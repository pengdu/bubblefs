...
// toft/base/type_cast.h

#ifndef BUBBLEFS_UTILS_TOFT_BASE_TYPE_CAST_H_
#define BUBBLEFS_UTILS_TOFT_BASE_TYPE_CAST_H_
...
ToType bitwise_cast(FromType from) {
    MYTOFT_STATIC_ASSERT(sizeof(FromType) == sizeof(ToType));
    union {
        FromType from;
        ToType to;
    } u = { from };
...
#endif // BUBBLEFS_UTILS_TOFT_BASE_TYPE_CAST_H_
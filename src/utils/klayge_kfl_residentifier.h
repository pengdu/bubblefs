...
// KlayGE/KFL/include/KFL/ResIdentifier.hpp

#ifndef BUBBLEFS_UTILS_KLAYGE_KFL_RESIDENTIFIER_H_
#define BUBBLEFS_UTILS_KLAYGE_KFL_RESIDENTIFIER_H_
...
#endif // BUBBLEFS_UTILS_KLAYGE_KFL_RESIDENTIFIER_H_
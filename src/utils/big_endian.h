...
// brpc/src/butil/big_endian.h

#ifndef BUBBLEFS_UTILS_BIG_ENDIAN_H_
#define BUBBLEFS_UTILS_BIG_ENDIAN_H_
...
class BASE_EXPORT BigEndianReader {
 public:
  ...
  bool ReadPiece(StringPiece* out, size_t len);
...
#endif  // BUBBLEFS_UTILS_BIG_ENDIAN_H_
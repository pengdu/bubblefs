...
// mesos/3rdparty/stout/include/stout/uuid.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_UUID_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_UUID_H_
...
struct hash<id::UUID>
{
  ...
  typedef bubblefs::mymesos::id::UUID argument_type;
...
#endif // BUBBLEFS_UTILS_MESOS_STOUT_UUID_H_
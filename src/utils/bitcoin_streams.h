...
// bitcoin/master/src/streams.h

#ifndef BUBBLEFS_UTILS_BITCOIN_STREAMS_H_
#define BUBBLEFS_UTILS_BITCOIN_STREAMS_H_
...
#include <utility>
#include <vector>
#include "utils/bitcoin_zeroafterfree.h"
...
public:
    ...
    OverrideStream<Stream>& operator>>(T& obj)
    {
        ...
        mybitcoin::Unserialize(*this, obj);
        return (*this);
    }
...
*/
    ...
    {
        mybitcoin::SerializeMany(*this, std::forward<Args>(args)...);
    }
    void write(const char* pch, size_t nSize)
    {
...
#endif // BUBBLEFS_UTILS_BITCOIN_STREAMS_H_
...
// tensorflow/tensorflow/core/distributed_runtime/rpc/grpc_call.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_GRPC_CALL_H_
#define BUBBLEFS_UTILS_TENSORFLOW_GRPC_CALL_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_GRPC_CALL_H_
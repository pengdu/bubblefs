...
#ifndef BUBBLEFS_UTILS_INT_TYPE_H_
#define BUBBLEFS_UTILS_INT_TYPE_H_
...
#define TF_LIB_GTL_DEFINE_INT_TYPE(int_type_name, value_type)          \
  ...
  typedef ::bubblefs::gtl::IntType<int_type_name##_tag_, value_type> \
      int_type_name;
...
#endif  // BUBBLEFS_UTILS_INT_TYPE_H_
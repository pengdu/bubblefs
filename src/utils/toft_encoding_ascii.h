...
// toft/encoding/ascii.h

#ifndef BUBBLEFS_UTILS_TOFT_ENCODING_ASCII_H_
#define BUBBLEFS_UTILS_TOFT_ENCODING_ASCII_H_
...
#endif // BUBBLEFS_UTILS_TOFT_ENCODING_ASCII_H_
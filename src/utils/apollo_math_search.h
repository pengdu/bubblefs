...
// apollo/modules/common/math/search.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_MATH_SEARCH_H_
#define BUBBLEFS_UTILS_APOLLO_MATH_SEARCH_H_
...
#endif // BUBBLEFS_UTILS_APOLLO_MATH_SEARCH_H_
...
// simcc/simcc/string_util.h

#ifndef BUBBLEFS_UTILS_SIMCC_STRING_UTILS_H_
#define BUBBLEFS_UTILS_SIMCC_STRING_UTILS_H_
...
#endif // BUBBLEFS_UTILS_SIMCC_STRING_UTILS_H_
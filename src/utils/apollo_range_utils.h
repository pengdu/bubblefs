...
// apollo/modules/routing/graph/range_utils.h

#ifndef BUBBLEFS_UTILS_APOLLO_RANGE_UTILS_H
#define BUBBLEFS_UTILS_APOLLO_RANGE_UTILS_H
...
#endif  // BUBBLEFS_UTILS_APOLLO_RANGE_UTILS_H
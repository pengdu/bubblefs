...
// Paddle/paddle/string/piece.h

#ifndef BUBBLEFS_UTILS_PADDLE_STRING_PIECE_H_
#define BUBBLEFS_UTILS_PADDLE_STRING_PIECE_H_
...
#endif // BUBBLEFS_UTILS_PADDLE_STRING_PIECE_H_
...
// muduo/muduo/net/ZlibStream.h

#ifndef BUBBLEFS_UTILS_MUDUO_NET_ZLIB_STREAM_H_
#define BUBBLEFS_UTILS_MUDUO_NET_ZLIB_STREAM_H_
...
#endif // BUBBLEFS_UTILS_MUDUO_NET_ZLIB_STREAM_H_
...
// tensorflow/tensorflow/core/distributed_runtime/master_interface.h

#ifndef BUBBLEFS_UTILS_TENSORFLOW_MASTER_INTERFACE_H_
#define BUBBLEFS_UTILS_TENSORFLOW_MASTER_INTERFACE_H_
...
#endif  // BUBBLEFS_UTILS_TENSORFLOW_MASTER_INTERFACE_H_
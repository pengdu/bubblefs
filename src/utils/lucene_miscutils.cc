...
// LucenePlusPlus/src/core/util/MiscUtils.cpp

#include "utils/lucene_miscutils.h"
#include <cstring>
...
bool MiscUtils::equalTypes(const ObjectPtr& first, const ObjectPtr& second) {
    const Object& firstRef(*first);
    const Object& secondRef(*second);

...
// KlayGE/KFL/include/KFL/AlignedAllocator.hpp

#ifndef BUBBLEFS_UTILS_KLAYGE_KFL_ALIGNED_ALLOCATOR_H_
#define BUBBLEFS_UTILS_KLAYGE_KFL_ALIGNED_ALLOCATOR_H_
...
#endif // BUBBLEFS_UTILS_KLAYGE_KFL_ALIGNED_ALLOCATOR_H_
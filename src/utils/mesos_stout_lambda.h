...
// mesos/3rdparty/stout/include/stout/lambda.hpp

#ifndef BUBBLEFS_UTILS_MESOS_STOUT_LAMBDA_H_
#define BUBBLEFS_UTILS_MESOS_STOUT_LAMBDA_H_
...
#include "utils/mesos_stout_cpp.h"
#include "utils/mesos_stout_result_of.h"
...
template <typename F, typename... Args>
struct is_bind_expression<bubblefs::mymesos::lambda::internal::Partial<F, Args...>>
  : true_type {};

} // namespace std

#endif // BUBBLEFS_UTILS_MESOS_STOUT_LAMBDA_H_
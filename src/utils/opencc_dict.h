...
#ifndef BUBBLEFS_UTILS_OPENCC_DICT_H_
#define BUBBLEFS_UTILS_OPENCC_DICT_H_

#include "utils/opencc_dict_entry.h"
#include "utils/opencc_lexicon.h"
#include "utils/opencc_optional.h"
...
public:
  ...
  */
  virtual std::vector<const DictEntry*> MatchAllPrefixes(const char* word) const;

  /**
  * Returns all matched prefixes of a word, sorted by the length (desc).
  */
  std::vector<const DictEntry*> MatchAllPrefixes(const string& word) const {
...
#endif // BUBBLEFS_UTILS_OPENCC_DICT_H_
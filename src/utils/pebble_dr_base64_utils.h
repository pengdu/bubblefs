...
// Pebble/src/framework/dr/protocol/base64_utils.h

#ifndef BUBBLEFS_UTILS_PEBBLE_DR_BASE64_UTILS_H_
#define BUBBLEFS_UTILS_PEBBLE_DR_BASE64_UTILS_H_
...
#endif // BUBBLEFS_UTILS_PEBBLE_DR_BASE64_UTILS_H_
...
#ifndef BUBBLEFS_UTILS_CAFFE_LAYER_H_
#define BUBBLEFS_UTILS_CAFFE_LAYER_H_
...
class Layer {
 public:
   ...
   */
  inline Dtype Forward(const std::vector<Blob<Dtype>*>& bottom,
      const std::vector<Blob<Dtype>*>& top);
   ...
   */
  inline void Backward(const std::vector<Blob<Dtype>*>& top,
...
#endif  // BUBBLEFS_UTILS_CAFFE_LAYER_H_
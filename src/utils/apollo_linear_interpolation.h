...
// pollo/modules/common/math/linear_interpolation.h
...
#ifndef BUBBLEFS_UTILS_APOLLO_LINEAR_INTERPOLATION_H_
#define BUBBLEFS_UTILS_APOLLO_LINEAR_INTERPOLATION_H_
...
T lerp(const T& x0, const double t0, const T& x1, const double t1,
  ...
  if (std::abs(t1 - t0) <= 1.0e-6) {
    PRINTF_ERROR("input time difference is too small\n");
    return x0;
  }
...
#endif  // BUBBLEFS_UTILS_APOLLO_LINEAR_INTERPOLATION_H_
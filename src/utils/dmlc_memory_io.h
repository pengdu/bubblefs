...
// dmlc-core/include/dmlc/memory_io.h

#ifndef BUBBLEFS_UTILS_DMLC_MEMORY_IO_H_
#define BUBBLEFS_UTILS_DMLC_MEMORY_IO_H_
...
struct MemoryFixedSizeStream : public SeekStream {
 public:
  ...
  virtual size_t Read(void *ptr, size_t size) {
    PANIC_ENFORCE(curr_ptr_ + size <= buffer_size_, "");
 ...
 */
struct MemoryStringStream : public SeekStream {
 public:
  /*!
   * \brief constructor
  ...
  virtual size_t Read(void *ptr, size_t size) {
    PANIC_ENFORCE(curr_ptr_ <= p_buffer_->length(), "");
...
#endif  // BUBBLEFS_UTILS_DMLC_MEMORY_IO_H_
...
// mars/mars/comm/socket/nat64_prefix_util.h

#ifndef BUBBLEFS_PLATFORM_MARS_NAT64_PREFIX_UTIL_H_
#define BUBBLEFS_PLATFORM_MARS_NAT64_PREFIX_UTIL_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_NAT64_PREFIX_UTIL_H_
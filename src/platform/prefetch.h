...
// tensorflow/tensorflow/core/platform/prefetch.h

#ifndef BUBBLEFS_PLATFORM_PREFETCH_H_
#define BUBBLEFS_PLATFORM_PREFETCH_H_
...
#endif  // BUBBLEFS_PLATFORM_PREFETCH_H_

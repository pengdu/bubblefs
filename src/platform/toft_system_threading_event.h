...
// toft/system/threading/event.h

#ifndef BUBBLEFS_PLATFOMR_TOFT_SYSTEM_THREADING_EVENT_H_
#define BUBBLEFS_PLATFOMR_TOFT_SYSTEM_THREADING_EVENT_H_
...
#endif // BUBBLEFS_PLATFOMR_TOFT_SYSTEM_THREADING_EVENT_H_
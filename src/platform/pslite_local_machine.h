...
// parameter_server/src/util/local_machine.h

#ifndef BUBBLEFS_PLATFORM_PSLITE_LOCAL_MACHINE_H_
#define BUBBLEFS_PLATFORM_PSLITE_LOCAL_MACHINE_H_
...
#endif // BUBBLEFS_PLATFORM_PSLITE_LOCAL_MACHINE_H_
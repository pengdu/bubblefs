...
// tera/src/common/base/byte_order.h

#ifndef BUBBLEFS_PLATFORM_BDCOM_BYTE_ORDER_H_
#define BUBBLEFS_PLATFORM_BDCOM_BYTE_ORDER_H_
...
#endif // BUBBLEFS_PLATFORM_BDCOM_BYTE_ORDER_H_
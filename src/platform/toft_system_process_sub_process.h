...
// toft/system/process/sub_process.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_PROCESS_SUB_PROCESS_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_PROCESS_SUB_PROCESS_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_PROCESS_SUB_PROCESS_H_
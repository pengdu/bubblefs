...
// mars/mars/comm/socket/tcpclient.h

#ifndef BUBBLEFS_PLATFORM_MARS_TCPCLIENT_H_
#define BUBBLEFS_PLATFORM_MARS_TCPCLIENT_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_TCPCLIENT_H_
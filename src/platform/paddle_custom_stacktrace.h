...
// Paddle/paddle/utils/CustomStackTrace.h

#ifndef BUBBLEFS_PLATFORM_PADDLE_CUSTOM_STACKTRACE_H_
#define BUBBLEFS_PLATFORM_PADDLE_CUSTOM_STACKTRACE_H_
...
#endif // BUBBLEFS_PLATFORM_PADDLE_CUSTOM_STACKTRACE_H_
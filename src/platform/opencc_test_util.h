...
// OpenCC/src/TestUtils.hpp

#ifndef BUBBLEFS_PLATFORM_OPENCC_TEST_UTIL_H_
#define BUBBLEFS_PLATFORM_OPENCC_TEST_UTIL_H_
...
#endif // BUBBLEFS_PLATFORM_OPENCC_TEST_UTIL_H_
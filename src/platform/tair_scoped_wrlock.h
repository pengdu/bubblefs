...
// tair/src/common/scoped_wrlock.hpp

#ifndef BUBBLEFS_PLATFORM_TAIR_SCOPED_WRLOCK_H_
#define BUBBLEFS_PLATFORM_TAIR_SCOPED_WRLOCK_H_
...
#endif // BUBBLEFS_PLATFORM_TAIR_SCOPED_WRLOCK_H_
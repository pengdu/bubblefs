...
// simcc/simcc/gettimeofday.h

#ifndef BUBBLEFS_PLATFORM_SIMCC_GETTIMEOFDAY_H_
#define BUBBLEFS_PLATFORM_SIMCC_GETTIMEOFDAY_H_
...
#endif // BUBBLEFS_PLATFORM_SIMCC_GETTIMEOFDAY_H_
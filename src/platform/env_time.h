...
// tensorflow/tensorflow/core/platform/env_time.h

#ifndef BUBBLEFS_PLATFORM_ENV_TIME_H_
#define BUBBLEFS_PLATFORM_ENV_TIME_H_
...
#endif  // BUBBLEFS_PLATFORM_ENV_TIME_H_

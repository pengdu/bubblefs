...
// brpc/src/butil/format_macros.h

#ifndef BUBBLEFS_PLATFORM_FORMAT_MACROS_H_
#define BUBBLEFS_PLATFORM_FORMAT_MACROS_H_
...
#endif  // BUBBLEFS_PLATFORM_FORMAT_MACROS_H_
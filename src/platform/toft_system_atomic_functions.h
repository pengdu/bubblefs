...
// toft/system/atomic/functions.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_ATOMIC_FUNCTIONS_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_ATOMIC_FUNCTIONS_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_ATOMIC_FUNCTIONS_H_
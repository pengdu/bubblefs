...
// mars/mars/comm/socket/tcpserver_fsm.h

#ifndef BUBBLEFS_PLATFORM_MARS_TCPSERVER_FSM_H_
#define BUBBLEFS_PLATFORM_MARS_TCPSERVER_FSM_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_TCPSERVER_FSM_H_
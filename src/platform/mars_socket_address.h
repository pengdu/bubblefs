...
// mars/mars/comm/socket/socket_address.h

#ifndef BUBBLEFS_PLATORM_MARS_SOCKET_ADDRESS_H_
#define BUBBLEFS_PLATORM_MARS_SOCKET_ADDRESS_H_
...
#endif // BUBBLEFS_PLATORM_MARS_SOCKET_ADDRESS_H_
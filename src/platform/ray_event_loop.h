...
// ray/src/common/event_loop.h

#ifndef BUBBLEFS_PLATFORM_RAY_EVENT_LOOP_H_
#define BUBBLEFS_PLATFORM_RAY_EVENT_LOOP_H_
...
#endif // BUBBLEFS_PLATFORM_RAY_EVENT_LOOP_H_
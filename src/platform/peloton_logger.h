...
// peloton/src/include/common/logger.h

#ifndef BUBBLEFS_PLATFORM_PELOTON_LOGGER_H_
#define BUBBLEFS_PLATFORM_PELOTON_LOGGER_H_
...
#endif // BUBBLEFS_PLATFORM_PELOTON_LOGGER_H_
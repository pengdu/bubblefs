...
// tensorflow/tensorflow/core/platform/default/fingerprint.h

#ifndef BUBBLEFS_PLATFORM_FINGERPRINT_H_
#define BUBBLEFS_PLATFORM_FINGERPRINT_H_
...
#endif  // BUBBLEFS_PLATFORM_FINGERPRINT_H_
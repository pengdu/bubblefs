...
// mars/mars/comm/unix/thread/condition.h

#ifndef BUBBLEFS_PLATFORM_MARS_CONDITION_H_
#define BUBBLEFS_PLATFORM_MARS_CONDITION_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_CONDITION_H_
...
// brpc/src/butil/synchronization/waitable_event.h

#ifndef BUBBLEFS_PLATFORM_WAITABLE_EVENT_H_
#define BUBBLEFS_PLATFORM_WAITABLE_EVENT_H_
...
class BASE_EXPORT WaitableEvent {
 ...
 private:
  ...
  struct WaitableEventKernel :
      public core::RefCountedThreadSafe<WaitableEventKernel> {
   public:
...
#endif  // BUBBLEFS_PLATFORM_WAITABLE_EVENT_H_
...
// toft/system/time/date.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_TIME_DATE_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_TIME_DATE_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_TIME_DATE_H_
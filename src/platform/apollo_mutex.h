...
// apollo/modules/perception/lib/base/mutex.h

#ifndef BUBBLEFS_PLATFORM_APOLLO_MUTEX_H_
#define BUBBLEFS_PLATFORM_APOLLO_MUTEX_H_
...
#endif  // BUBBLEFS_PLATFORM_APOLLO_MUTEX_H_
...
// mars/mars/comm/socket/tcpclient_fsm.h

#ifndef BUBBLEFS_PLATFORM_MARS_TCPCLIENTFSM_H_
#define BUBBLEFS_PLATFORM_MARS_TCPCLIENTFSM_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_TCPCLIENTFSM_H_
...
// mars/mars/comm/thread/mutexvector.h

#ifndef BUBBLEFS_PLATFORM_MARS_MUTEXVECTOR_H_
#define BUBBLEFS_PLATFORM_MARS_MUTEXVECTOR_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_MUTEXVECTOR_H_
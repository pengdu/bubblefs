...
// tair/src/common/syncproc.hpp

#ifndef BUBBLEFS_PLATFORM_TAIR_SYNCPROC_H_
#define BUBBLEFS_PLATFORM_TAIR_SYNCPROC_H_
...
#endif // BUBBLEFS_PLATFORM_TAIR_SYNCPROC_H_
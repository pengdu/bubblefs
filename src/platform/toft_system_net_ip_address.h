...
// toft/system/net/ip_address.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_IP_ADDRESS_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_IP_ADDRESS_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_IP_ADDRESS_H_
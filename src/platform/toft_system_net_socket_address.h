...
// toft/system/net/socket_address.h

#ifndef BUBBLEFS_UTILS_TOFT_SYSTEM_NET_SOCKET_ADDRESS_H_
#define BUBBLEFS_UTILS_TOFT_SYSTEM_NET_SOCKET_ADDRESS_H_
...
#endif // BUBBLEFS_UTILS_TOFT_SYSTEM_NET_SOCKET_ADDRESS_H_
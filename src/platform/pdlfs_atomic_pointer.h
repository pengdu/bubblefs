...
// pdlfs-common/include/pdlfs-common/atomic_pointer.h

#ifndef BUBBLEFS_UTILS_PLATFORM_PDLFS_ATOMIC_POINTER_H_
#define BUBBLEFS_UTILS_PLATFORM_PDLFS_ATOMIC_POINTER_H_

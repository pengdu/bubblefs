...
// muduo/muduo/base/TimeZone.h

#ifndef BUBBLEFS_PLATFORM_MUDUO_TIMEZONE_H_
#define BUBBLEFS_PLATFORM_MUDUO_TIMEZONE_H_
...
#endif  // BUBBLEFS_PLATFORM_MUDUO_TIMEZONE_H_
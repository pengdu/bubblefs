...
// cpp11-on-multicore/common/autoreseteventcondvar.h

#ifndef BUBBLEFS_PLATFORM_RDSN_AUTORESETEVENT_CONDVAR_H_
#define BUBBLEFS_PLATFORM_RDSN_AUTORESETEVENT_CONDVAR_H_

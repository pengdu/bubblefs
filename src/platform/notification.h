...
// tensorflow/tensorflow/core/platform/default/notification.h

#ifndef BUBBLEFS_PLATFORM_NOTIFICATION_H_
#define BUBBLEFS_PLATFORM_NOTIFICATION_H_
...
#endif  // BUBBLEFS_PLATFORM_NOTIFICATION_H_
...
// mars/mars/comm/network/getifaddrs.h

#ifndef BUBBLEFS_PLATFORM_MARS_GETIFADDRS_H_
#define BUBBLEFS_PLATFORM_MARS_GETIFADDRS_H_
...
#endif // BUBBLEFS_PLATFORM_MARS_GETIFADDRS_H_
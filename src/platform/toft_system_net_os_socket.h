...
// toft/system/net/os_socket.h

#ifndef BUBBLEFS_UTILS_TOFT_SYSTEM_NET_OS_SOCKET_H_
#define BUBBLEFS_UTILS_TOFT_SYSTEM_NET_OS_SOCKET_H_
...
#endif // BUBBLEFS_UTILS_TOFT_SYSTEM_NET_OS_SOCKET_H_
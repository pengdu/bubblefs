...
// toft/system/event_dispatcher/event_dispatcher.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H_
...
class EventDispatcher {
    DECLARE_UNCOPYABLE(EventDispatcher);
...
class EventWatcherBase : private CWatcherType {
    DECLARE_UNCOPYABLE(EventWatcherBase);
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H_
...
#ifndef BUBBLEFS_PLATFORM_PEBBLE_NET_UTIL_H_
#define BUBBLEFS_PLATFORM_PEBBLE_NET_UTIL_H_
...
#define PEBBLE_NETADDR_IP_PRINT_FMT   "%u.%u.%u.%u:%u"
#define PEBBLE_NETADDR_IP_PRINT_CTX(socket_info) \
...
static const int NET_LOG_DEBUG_LEVEL = 0;
static const int NET_LOG_INFO_LEVEL = 1;
static const int NET_LOG_ERROR_LEVEL = 2;

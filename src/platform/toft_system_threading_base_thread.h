...
// toft/system/threading/base_thread.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_BASE_THREAD_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_BASE_THREAD_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_BASE_THREAD_H_
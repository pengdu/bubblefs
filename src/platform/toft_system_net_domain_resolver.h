...
// toft/system/net/domain_resolver.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_DOMAIN_RESOLVER_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_DOMAIN_RESOLVER_H_
...
#include "platform/toft_system_net_ip_address.h"
...
template <>
inline void swap(bubblefs::mytoft::HostEntry& h1, bubblefs::mytoft::HostEntry& h2)
{
    h1.Swap(&h2);
}
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_NET_DOMAIN_RESOLVER_H_
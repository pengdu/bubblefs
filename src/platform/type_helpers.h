...
// android/platform_system_core/libutils/include/utils/TypeHelpers.h

#ifndef BUBBLEFS_UTILS_TYPE_HELPERS_H_
#define BUBBLEFS_UTILS_TYPE_HELPERS_H_
...
#endif // BUBBLEFS_UTILS_TYPE_HELPERS_H_
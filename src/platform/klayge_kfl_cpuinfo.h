...
// KlayGE/KFL/include/KFL/CpuInfo.hpp

#ifndef BUBBLEFS_PLATFORM_KLAYGE_KFL_CPUINFO_H_
#define BUBBLEFS_PLATFORM_KLAYGE_KFL_CPUINFO_H_
...
#endif  // BUBBLEFS_PLATFORM_KLAYGE_KFL_CPUINFO_H_
...
// tensorflow/tensorflow/stream_executor/lib/static_threadlocal.h

#ifndef BUBBLEFS_PLATFORM_STATIC_THREADLOCAL_H_
#define BUBBLEFS_PLATFORM_STATIC_THREADLOCAL_H_
...
#endif  // BUBBLEFS_PLATFORM_STATIC_THREADLOCAL_H_
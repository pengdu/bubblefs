...
// mars/mars/comm/unix/socket/socketpoll.h

#ifndef BUBBLEFS_PLATFORM_MARS_SOCKETPOLL_H_
#define BUBBLEFS_PLATFORM_MARS_SOCKETPOLL_H_ 
...
#endif // BUBBLEFS_PLATFORM_MARS_SOCKETPOLL_H_
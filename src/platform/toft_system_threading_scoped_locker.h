...
// toft/system/threading/scoped_locker.h

#ifndef BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_SCOPED_LOCKER_H_
#define BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_SCOPED_LOCKER_H_
...
#endif // BUBBLEFS_PLATFORM_TOFT_SYSTEM_THREADING_SCOPED_LOCKER_H_